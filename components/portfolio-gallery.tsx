...
const images: GalleryImage[] = [
  {
    ...
    alt: "Stylizacja rzęs 1:1 – efekt naturalny",
    category: "rzesy",
    tall: true,
  },
  {
    src: "/placeholder.svg?height=700&width=900",
    alt: "Makijaż ślubny – klasyczna elegancja",
    category: "makijaz",
    wide: true,
  },
  {
    src: "/placeholder.svg?height=700&width=700",
    alt: "Stylizacja rzęs 2-3D – objętość",
    category: "rzesy",
  },
  {
    src: "/placeholder.svg?height=700&width=700",
    alt: "Makijaż okolicznościowy – wieczorowy glamour",
    category: "makijaz",
  },
  {
    src: "/placeholder.svg?height=900&width=700",
  ...
  {
    src: "/placeholder.svg?height=700&width=900",
    alt: "Makijaż okolicznościowy – delikatny bridal",
    category: "makijaz",
    wide: true,
  },
  {
    src: "/placeholder.svg?height=700&width=700",
    alt: "Stylizacja rzęs 5D – dramatyczny efekt",
    category: "rzesy",
  },
  {
    src: "/placeholder.svg?height=900&width=700",
    alt: "Kolorowe rzęsy – akcent w stylizacji",
    category: "rzesy",
    tall: true,
  },
  {
    src: "/placeholder.svg?height=700&width=700",
    alt: "Makijaż wieczorowy – smoky eye",
    category: "makijaz",
  },
  {
    src: "/placeholder.svg?height=700&width=700",
    alt: "Stylizacja rzęs 3-4D – naturalny efekt",
    category: "rzesy",
  },
]
